...
CREATE TABLE "promotion_variant_targets" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"promotion_id" uuid NOT NULL,
	"variant_id" uuid NOT NULL,
	CONSTRAINT "promotion_variant_targets_promotion_variant_unique" UNIQUE("promotion_id","variant_id")
);
--> statement-breakpoint
...
ALTER TABLE "promotion_variant_targets" ADD CONSTRAINT "promotion_variant_targets_promotion_id_promotions_id_fk" FOREIGN KEY ("promotion_id") REFERENCES "public"."promotions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "promotion_variant_targets" ADD CONSTRAINT "promotion_variant_targets_variant_id_product_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."product_variants"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
