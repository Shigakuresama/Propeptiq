...
describe("ProductPurchasePanel", () => {
  ...
  it.each([
    ...
    ["preview zero", testPublicVariant({ priceStatus: "pending", availability: "preview_only", baseUnitMinor: 0, currency: "USD", checkoutReady: false }), "Test mode — no payments", true],
