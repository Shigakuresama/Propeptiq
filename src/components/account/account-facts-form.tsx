...
export function AccountFactsForm({
  ...
  return (
    <form action={action} className="grid gap-6" aria-label="Verified account facts">
      <div>
      ...
      <section className="record-row" aria-labelledby="attestation-heading">
        <p className="eyebrow">Current attestation · version {attestation.version}</p>
        <h2 id="attestation-heading" className="mt-3 font-heading text-2xl">Research-use attestation</h2>
