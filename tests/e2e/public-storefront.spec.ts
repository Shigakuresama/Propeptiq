...
test("Tesmorelin gallery decodes its five individual alternate scenes", async ({ page }) => expectIndividualAlternateGallery(page, { slug: "tesmorelin", name: "Tesmorelin", variant: "5mg" }));
...
test("TB500 gallery decodes its five individual alternate scenes", async ({ page }) => expectIndividualAlternateGallery(page, { slug: "tb500", name: "TB500 (Thymosin B4 acetate)", variant: "5mg" }));
