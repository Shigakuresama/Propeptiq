...
**September 5, 2026 release candidate:** Commit `f91ea55937df4a524fbceccb8cec4edd91412fc5` contains the six-view illustration gallery, product bibliography, revised Why Choose presentation, grouped FAQ with matching structured data, and related-card corrections described below. This candidate has passed the final local gate; merge, deployment, and live verification are separate pending steps. The owner's authorization to implement, merge, and deploy remains in effect.
