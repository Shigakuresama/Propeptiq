...
**PR #29 verification snapshot (before merge):** [PR #29](https://github.com/Shigakuresama/Propeptiq/pull/29) adds the accepted shared motion/lifecycle refinements, narrow-cart layout repair, ordinary cart wording, and four Selank/Semax bibliography records. Its bibliography has 22 mapped compounds / 37 studies / two correction notices / zero product claims. The final local production build at `db991c54a46b565bba40b9d9ba3ec510c20a1f73` passed with stable build/source fingerprints, 18 cold CLS-zero samples, 28 JavaScript layouts, 14 no-JavaScript cases and four reduced-motion cases. Unit 3,541, integration 551 (three guarded skips), all 174 existing browser cases across recorded runs plus targeted test repairs, lint/typecheck/boundary, build, artifact scan and migration checks have evidence in the [completion plan](../superpowers/plans/2026-09-04-propeptiq-storefront-completion.md). The two original browser invocations with failures are not claimed to have exited successfully. See PR #29 for the subsequent merge, exact deployment and live read-back; this snapshot alone is not production proof. Frame observations are not proof of 60fps or scripting cost. Broader homepage/catalog wording, individual product imagery, missing prices/content and provider activation remain unfinished.

**Current September 5, 2026 bounded release:** PR #27 merged as `975a96f2ae047bb6b5e94785a5d5da82205833d1`; its merged tree exactly equals tested tree `3d5629ec2186323daf2b1850ab0e779fa33fef75`. READY deployment `dpl_59UcYsjoafr56TpdWC11jbXD91Et` at <https://propeptiq-43xw3wg8h-sergiosteam.vercel.app> serves <https://propeptiq.com/> and its `www` alias. The final browser gate passed 158/158 with zero unexpected, skipped or flaky tests; lint, route type generation, typecheck, fresh Turbopack build, workspace-boundary and artifact checks passed. The scan covered 1,260 files / 70,924,780 bytes / 0 forbidden matches. This release adds the neutral 20-compound / 33-study / 2-notice / 0-claim bibliography and the bounded compact-header fix. It does not complete the wider storefront, broader responsive/performance work, payment, providers or business approvals.

**Historical PR #17 visible release:** PR #17 merged the locally tested source candidate `f91ea55937df4a524fbceccb8cec4edd91412fc5` as `365b2acc673063643607b4aae1695e22bad49bab`. READY deployment `dpl_gSy5LMPTunhaifMUuJ4d3BgfA6fw` serves <https://propeptiq.com/> with the six-view illustration gallery, product bibliography, Why Choose cards, grouped FAQ/structured data, transparent logo, and related-card corrections. Phone/tablet/desktop live checks confirm those surfaces. See the [completion plan](../superpowers/plans/2026-09-04-propeptiq-storefront-completion.md) for exact evidence and unfinished tasks. This is not full-storefront completion or permission to activate payment.

Historical live testing also found a preexisting legacy-cart migration defect. PR #18 corrected it and deployed as `53372558e79c53e027fa217fec94b59daeee9d11` / READY `dpl_91pveTQACNnH6WsmCD72m4eiiaSR`. Empty v1 now loads ready; nonempty v1 remains untouched until explicit acknowledgement, and ADD shows a visible cart-review link instead of accepting an unsaved item. The correction passed 3,457 unit tests and four focused browser cases, plus lint/typecheck/build/artifact checks. Production add/merge/reload preserved Tirzepatide 30mg quantity 2 and `$83.98`, with checkout disabled; verification items were removed afterward. Historical candidate-stage notes below describe earlier checkpoints; this release status supersedes pending-release wording, but does not close missing prices, content, policies, providers, or recurring-commerce decisions.

**Historical PR #17 local evidence:** full browser 109/109 passed, zero skipped, unexpected, or flaky tests (504.217 seconds); independent pricing/tier/cart browser rerun 1/1 passed; full unit 229 files / 3,446 tests passed (33.44 seconds); lint, typecheck, workspace boundary, artifact-scanner 11/11, and Turbopack build passed. The final production artifact scan checked 1,260 files / 70,755,659 bytes with zero forbidden artifacts. Integration passed 33 files / 551 tests in 946.90 seconds; one guarded PostgreSQL-auth file / 3 tests was skipped and is not real-PostgreSQL verification. Gallery/search overlap, 195px no-JavaScript heading wrapping, and stale legacy-route test expectations were repaired and reverified. During an early browser batch, one not-yet-executed pricing-test locator was scoped to the named purchase summary; production source stayed unchanged throughout, and that test passed independently afterward. Local evidence is not deployment proof. Existing screenshot-only development hydration warnings and LCP hints remain distinguished from the explicit no-application-error browser assertions and pending live production logs.

Fresh PR #27 production checks found equal document client/scroll widths at requested 320/375/768/1440px: 305/360/753/1425px. At 320px the menu ended at 288.667px and all four header actions were 44x44px; at 375px the full wordmark remained. ARA-290, SS-31 and Thymosin Alpha-1 each showed exactly two PubMed references at 375/768/1440px; the two correction notices stayed nested under their exact parents and did not increase study counts. Native disclosure keyboard behavior, 44px correction-link focus targets with visible moss outlines, the specific `/catalog/ara-290` redirect, settled footer/dock/search clearance, empty fresh-tab warning/error logs and final viewport reset were verified. WINTER30 and selected prices remained visible; the newsletter remained disabled and unchecked, checkout remained disabled, the cart stayed empty, and no address, payment, provider or production-data mutation occurred.
...
**Unreleased local addition:** candidate `a9ad6613bedb31f1512eb4a30c71392e8566c98d` adds exact Selank and Semax joins and four study records, producing 22 compounds / 37 studies / 2 notices / 0 claims locally. The previous 20/33 records and review dates are unchanged. The separate `semax-selank` blend remains unmapped. Focused tests passed 87/87, the product-content browser file passed 22/22, and the full unit suite passed 233 files / 3,540 tests. Independent scoped review approved the change with no Critical or Important findings. Final publication-status readback, combined release checks, merge and deployed proof remain pending; these are not yet additional live references.

The current production release has exact product-to-bibliography joins for 20 compounds and 33 unique study PMIDs, plus two separately linked correction notices and zero claims. Edit compound identity, catalog slug, aliases, study IDs, and identity notes in [`content/compounds.json`](../../content/compounds.json); edit verified bibliographic metadata in [`content/studies.json`](../../content/studies.json) and correction relationships in [`content/study-corrections.json`](../../content/study-corrections.json). Existing records retain their September 4 review dates; the six new studies have September 5 dates. Fresh September 5 NCBI EFetch read-back checked the eight added study/notice records, exact identifiers, publication types and reciprocal correction relationships. That indexed metadata check is not blanket DOI-redirect, product-relevance or clinical-claim verification. Preserve the detailed source-verification record with release evidence. [`content/claims-audit.json`](../../content/claims-audit.json) has an empty claims array; mechanisms and benefit claims remain null. These records describe cited studies, not tests of the product being sold.
...
The 20 deployed mappings are `tirzepatide`, `semaglutide`, `retatrutide`, `survodutide`, `cargrilintide`, `aod-9604`, `mots-c`, `nad-plus`, `5-amino-1mq`, `bpc-157`, `ghk-cu`, `tesmorelin`, `ipamorelin`, `cjc-1295-with-dac`, `sermorelin-acetate`, `igf-1-lr3`, `hcg`, `ara-290`, `ss-31`, and `thymosin-alpha-1`, leaving 36 products without a curated bibliography. Unmapped pages retain their neutral catalog information and literature-discovery link. Correction PMID `28059429` belongs only to parent `24136731`; `40447307` belongs only to `39814420`. Notices appear inside those parent references and never increase the study count. Adding a citation requires resolving its exact DOI/PMID against its primary source and checking compound/form/population relevance. A search result or similarly named compound must not populate an unmapped product. Product-specific technical/storage content, study summaries, owner-provided study attachments, and claims review remain outstanding.
...
The eight operational FAQs use the same content registry and public homepage projection. [`src/components/site/faq-section.tsx`](../../src/components/site/faq-section.tsx) uses native `details/summary` with the shared `name="propeptiq-home-faq"` group for single-open behavior without custom accordion JavaScript. [`src/components/site/faq-json-ld.tsx`](../../src/components/site/faq-json-ld.tsx) serializes exactly the same question/answer entries into one safely escaped `FAQPage` script; [`src/components/site/public-home.tsx`](../../src/components/site/public-home.tsx) supplies that same array to the visible FAQ and JSON-LD components. Add shipping, returns, testing, or subscription answers only when the corresponding policies/features and exact copy exist. Component parity, script escaping, native keyboard and JavaScript-disabled behavior are covered by the PR #27 release gate. Broader responsive/performance acceptance remains open.
...
Newsletter signup is intentionally closed. [`src/lib/site-content.ts`](../../src/lib/site-content.ts) has an empty approved privacy-destination policy and a frozen `newsletterConfiguration` with `enabled: false` and `privacyHref: null`. The shared public footer and API runtime consume that same launch flag. A privacy link or installed environment values alone cannot enable collection. The single form is owned by `SiteFooter`, not duplicated inside `PublicHome`; its optional `presentation="footer"` changes styling only and does not enable collection or alter validation.
...
The layout uses the existing transparent brand logo and mission with socials beneath it, followed by Shop, Support, and Legal groups: four desktop columns, two tablet columns, and one phone column. Each navigation group is one native, initially open disclosure; links remain readable without JavaScript and can be collapsed with the keyboard. The existing newsletter appears once below the groups, followed by approved-only notices, the existing research restrictions, and the current-year site attribution. These are layout choices, not new legal copy, trust claims or payment activation. The exact supplied footer attachment remains unavailable; this implementation follows the owner's described structure and does not claim to reproduce that attachment.
...
## Public motion configuration — unreleased candidate

The local accepted motion source through `fee172072eeac6aa937a7ad3b4a46481c1849073` is not yet merged or deployed. Change shared timing, easing and movement in [`src/app/globals.css`](../../src/app/globals.css), not individual page components: interactions are 200ms, public drawers 300ms, and reveals 240ms with a 12px rise and 70ms sibling stagger. The standard easing is `cubic-bezier(0.4, 0, 0.2, 1)`; the existing contained logo loop keeps its separate `--motion-ease-brand-drift` token. Rewards artwork is retained, with its two orbit groups static instead of continuously rotating.

[`scroll-reveal-controller.tsx`](../../src/components/site/scroll-reveal-controller.tsx) owns the 0.15 observer threshold, safe tall-section behavior, live reduced-motion response and route-navigation visibility. Essential content stays visible without JavaScript. [`sheet.tsx`](../../src/components/ui/sheet.tsx) accepts the optional `motionScope="public"` marker for navigation, site search, cart and variant selection; unmarked private sheets retain their existing behavior. Reduced-motion checks must inspect both legacy `transform` and individual `translate`, `rotate` and `scale`, while preserving functional transforms such as bottom-search centering.

The screenshot test uses `caret: "initial"` across its 16 captures; its regression checks watch for transient input-style mutations rather than suppressing hydration diagnostics. Measured performance and deployed browser proof remain open. See the [Task 18 checklist](../superpowers/plans/2026-09-04-propeptiq-storefront-completion.md#task-18-complete-the-shared-motion-and-responsive-polish-pass). Do not treat these configuration locations or focused test results as a completed performance certification.

The current production-build laboratory is **not verified**. Its third invocation failed at the 15-minute storefront-test deadline. Diagnosis identified an unanchored hidden cart-announcement footprint, an overwide empty-cart action at 195px, and test-harness defects including page-side asynchronous waits in JavaScript-disabled contexts. These are tracked as separate narrow repairs; do not loosen layout thresholds or suppress essential request/page errors to make a report pass. Background RSC-prefetch cancellation, when precisely identified, remains an unresolved diagnostic rather than proof of successful client navigation.

Do not store durable measurement evidence beneath ordinary Playwright output directories. A focused test cleared the earlier `test-results/performance` and diagnostic archives; only human/tool summaries and prior hashes survive. Subsequent focused tests must use unique, explicitly scoped output paths, and the laboratory's output-isolation repair must be verified before another measured run. Neither historical failed observations nor deleted raw evidence establish production performance.
...
A working local build or Stripe API integration is not provider-account approval. A schema, test fixture, or admin draft is not a production record. Production database contents and provider state remain unverified. The bounded PR #27 deployment and browser behavior are verified in the release checkpoint above; this documentation-only update did not query a live database or provider, apply migrations, push, merge, deploy, or publish.
...
| Cutover and rollback | [production cutover](./production-cutover.md) and [incidents/recovery](./incidents-and-recovery.md) | Explicitly authorized deployment/operations owner | Backup, migration, provider, webhook, smoke test, rollback read-back | Completed presentation releases and exact deployments are recorded in the completion plan; operational database/provider cutover is not established by those releases |
...
- [ ] Complete research coverage where justified: the deployed 20 compounds / 33 studies / 2 separate correction notices / 0 claims leave 36 products without a curated bibliography. Product-specific study summaries, technical facts, storage wording, claims, and any exact product/form relevance statements still require source-specific review; metadata is not substantiation of a product claim.
...
- [ ] Complete any exact-reference adjustments once the missing footer attachment is recovered, remaining responsive/motion acceptance, and missing policies/provider activation. The mobile purchase dock and one-time cart drawer are delivered in PR #21 and PR #24; they do not implement recurring commerce. Footer layout release evidence is tracked separately in the completion plan above.
...
- [ ] Complete the remaining deployment-specific publication/capability, browser/build and live phone/tablet/desktop matrix after each accepted future release. PR #27's bounded bibliography/header release is merged and live verified; this does not close the wider storefront acceptance task.
- [ ] Complete legacy-route coverage beyond the one verified PR #27 example. Fresh production proof confirms `/catalog/ara-290` resolves to `/catalog/items/ara-290` with the correct ARA-290 heading and references section; no claim is made that every legacy path was retested.
