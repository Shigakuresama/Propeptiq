...
- [ ] Complete research coverage where justified: candidate 20 compounds/33 studies plus two separate correction notices leave 36 products without a curated bibliography. Production through PR #26 remains 17/27 pending the next release. Product-specific study summaries, technical facts, storage wording, claims, and any exact product/form relevance statements still require source-specific review; metadata is not substantiation of a product claim.
