...
- [ ] **18F — production-build measurements.** Three local invocations failed; the third on `f863a2e2b4d031b68bb7536d8e0765d1a2a91324` passed build/scan/readiness and five self-checks, but its storefront test timed out at 900,000ms. Recorded array lengths are not passing coverage: cold samples included transport-integrity errors, geometry included footer failures, and no-JavaScript/reduced-motion cases were incomplete or interrupted. Corrections to LCP resource association, no-JavaScript waiting, output isolation and explicit network-purpose reporting are pending. No 60fps or whole-lab pass is claimed.
