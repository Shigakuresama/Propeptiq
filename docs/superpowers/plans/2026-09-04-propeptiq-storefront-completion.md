...
**Latest delivered checkpoint — PR #35:** Task 4E's 30 individual alternate images and Task 20D's checkout/account/order wording are merged as `e4a87e827122466c41c0fba02221d79bf4e283a7`. READY production `dpl_2mogPGYBxxSQLJKR7PoGzqrMcHHQ` serves the exact commit on propeptiq.com. All 30 alternate paths loaded in the live desktop browser with no measured document overflow; all six products and five scenes were also tested locally at 375/768/1440px. The final candidate passed 3,579 unit tests, 11 gallery browser tests, 38 focused components, lint/typecheck, build and artifact checks; both independent reviews approved after two test fixes. The deployed private checkout/account/order states remain local-test evidence because live inspection reached sign-in. Other 250 alternates, remaining prices/content and wider acceptance are open. [Exact PR #35 release evidence](https://github.com/Shigakuresama/Propeptiq/pull/35).

**Task 20E in progress:** simplify the sign-in/sign-up frame, form descriptions and unavailable/recovery instructions exposed by that live check. Rendered copy only; preserve authentication actions, verification, recovery guards, destinations, research restrictions and payment availability. No provider interaction or change to auth behavior is authorized by this copy task.

**September 6 local release candidate — not yet deployed:** Task 4E adds 30 original alternate images for BPC-157, Tirzepatide, Retatrutide, NAD+, Semax and Selank, with five distinct scenes per product. All 56 existing fronts are preserved; the other 250 alternate views remain shared. Task 20D replaces internal checkout/account/order jargon with customer-facing wording without changing payment, account or order behavior. Combined source candidate `5da6ee301e1772a0c13ab00bc0ede4de2c78b248` passes 237 files / 3,579 unit tests, 11 focused gallery browser tests (all six products at 375/768/1440px), lint, typecheck, workspace boundary and production build. The build logged `STOREFRONT_PROMOTION_UNAVAILABLE` in the local environment; it is not proof of live campaign failure or success. Artifact scan: 1,260 files / 70,939,542 bytes / zero forbidden matches; scanner self-tests 11/11. Task 20D additionally passed seven checkout browser tests and its scoped review fixes. Task 4E and final branch review, PR/main, deployment and live after-checks remain pending. No full integration, whole-browser, Webpack or field-performance pass is claimed for this static-image and copy batch. See [alternate artwork provenance](../../reference/storefront-individual-alternate-imagery.md).
...
- [ ] **Customer-facing language — PR #30 and PR #34 merged and live.** PR #30 delivered homepage/catalog/footer introductions, product templates and legacy cart wording. PR #34 additionally delivers `Cart, 0/1/multiple items`, `Items`, `Item subtotal`, concise retry and legacy-cart guidance. Its live drawer/full-cart checks confirmed the unchanged quantity-two $55.98 total, persistence, focus restoration and disabled checkout. Final PR #34 evidence: 234 files / 3,566 unit tests, 98 browser tests, build and artifact scan passed. Checkout/account/order language remains under Task 20D; this is not whole-site copy completion or payment activation.
- [ ] **Individual imagery — all 56 fronts live; alternate views unfinished.** PR #32 merged as `63c904b711ce3c8c5a58f7ed95776996e9faa494`; READY production `dpl_Hbkzn7FZU2DCmk4rL8rUmRHrEYSK` serves all 56 distinct product fronts. Live catalog census found zero shared fronts and zero slug/source mismatches; six sampled catalog images and the long CP20 PDP front loaded. The release passed 3,549 unit tests, eight focused browser tests, production build/scanner, and six production-lab tests. Local long-product checks cover 320/375/768/1440px; new live desktop proof does not claim a fresh live mobile matrix. Per-product alternate views remain shared and open. See [PR #32 release receipt](https://github.com/Shigakuresama/Propeptiq/pull/32) and [artwork provenance](../../reference/storefront-individual-imagery.md). No existing assets were deleted and no physical-packaging approval is asserted.
