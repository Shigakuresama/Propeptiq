...
The pre-existing 195px product-body overflow remains a separately tracked Task 18A repair; this release does not claim universal narrow-page containment. Exact footer-reference matching, missing policies, real social URLs and newsletter activation remain unfinished.
