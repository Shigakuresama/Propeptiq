...
- [ ] **Customer-facing language — PR #29 live; PR #30 in review.** Cart actions and state labels no longer use `Cart preview`. PR #30 replaces the remaining homepage/catalog/footer introductions, product templates and legacy cart wording, while retaining honest unavailable states. It is not delivered until the corrected layout regressions, source review, build, merge and live read-back pass. Detailed receipt follows under Task 20.
