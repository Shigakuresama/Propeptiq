...
- [ ] **Individual imagery — Task 4C in implementation.** Six new original, product-named fronts have been created for BPC-157, Tirzepatide, Retatrutide, NAD+, Semax and Selank. Integration, review and deployed read-back are required before counting them delivered. Fifty other product fronts and per-product alternate views remain open. See [artwork provenance and prompts](../../reference/storefront-individual-imagery.md). No existing assets were deleted and no physical-packaging approval is asserted.
