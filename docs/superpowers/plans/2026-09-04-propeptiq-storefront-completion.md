...
- [ ] **Product pages — information still incomplete.** PR #33 expands the live neutral bibliography to 24 compounds / 41 studies / 2 separately nested correction notices / 0 claims; 32 products remain unmapped. DSIP and Epithalon's exact links, contexts, keyboard disclosures and individual fronts were inspected on the READY production release. Complete justified coverage and product-specific technical/storage information. Do not fill the remaining products with unrelated papers or generic protocols.
...
- [ ] **Customer-facing language — PR #30 merged and live.** Main `af3c8542177a95c92e20b450de0d581c6c181cb4`, READY deployment `dpl_7g9K495H7ixpyzrGbthVYoBXnPQL`, serves the updated homepage/catalog/footer introductions, product templates and legacy cart wording. Live cart merge/persistence, FAQ/search, gallery and phone/tablet/desktop checks passed; final unit evidence is 234 files / 3,545 tests. Honest unavailable states remain. Some secondary labels remain under Task 20; this is not whole-site copy completion.
