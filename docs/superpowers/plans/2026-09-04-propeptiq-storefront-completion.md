...
- [ ] **Remaining responsive and performance acceptance — open.** Task 18 is Partial: its full motion audit, complete width matrix, CLS target and 4x CPU inspection remain open. The delivered product-body and compact-header fixes must not be described as universal full-site responsive/performance acceptance.
