...
**Task 4F candidate — not yet released:** Thirty more original alternate illustrations are prepared for HGH, GHK-CU, Tesmorelin, Tesmorelin + IPA, TB500 and BPC + TB, with five scenes each. The measured assets are 1,254 × 1,254 pixels and total 1,482,200 bytes. After verified publication, this would bring individual alternate coverage to 60 views across 12 products, leaving 220 views for 44 products shared. Existing fronts, earlier alternates and shared masters are preserved. Integration, review, merge, deployment and live readback must be recorded before calling this batch delivered. [Batch-two artwork provenance](../../reference/storefront-individual-alternate-imagery-batch-two.md).
...
- [ ] **Individual imagery — all 56 fronts and 30 alternates for six products live; remaining alternates unfinished.** PR #32 merged as `63c904b711ce3c8c5a58f7ed95776996e9faa494`; READY production `dpl_Hbkzn7FZU2DCmk4rL8rUmRHrEYSK` serves all 56 distinct product fronts. Live catalog census found zero shared fronts and zero slug/source mismatches; six sampled catalog images and the long CP20 PDP front loaded. PR #35 additionally deployed five distinct alternate scenes for each of BPC-157, Tirzepatide, Retatrutide, NAD+, Semax and Selank: 30 live alternate paths. The other 250 alternate views remain shared and open. Local long-product and six-product alternate checks cover 320/375/768/1440px as applicable; no fresh live three-viewport matrix is claimed. See [PR #32 release receipt](https://github.com/Shigakuresama/Propeptiq/pull/32), [artwork provenance](../../reference/storefront-individual-imagery.md) and [alternate artwork provenance](../../reference/storefront-individual-alternate-imagery.md). No existing assets were deleted and no physical-packaging approval is asserted.
