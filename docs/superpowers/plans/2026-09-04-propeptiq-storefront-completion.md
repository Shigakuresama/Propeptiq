...
- Fresh live Tirzepatide: at requested240px/client225px the header/gallery/product-content boxes end at208.67px, quantity buttons are44px and the input is88.67px. The product remains contained at320/375/768/1440; normal input width is96px. Quantity2 displays standard59.99/effective41.99,30%discount,36.00savings and83.98subtotal; selection was restored to1 without adding to cart. The live browser cannot reproduce195px, so that exact width is proved only by the local browser suite. Inspected warning/errorlogs were empty and viewport override reset.
