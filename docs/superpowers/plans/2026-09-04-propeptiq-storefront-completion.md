...
**Latest delivered checkpoint — Task 4F / PR #38:** Thirty more original alternate illustrations for HGH, GHK-CU, Tesmorelin, Tesmorelin + IPA, TB500 and BPC + TB are merged as `c0a07151b9388c5a8ef3d46bb8322b4fa922937c`. READY production `dpl_7xdWecQnQGume7ZLUWSSTpwf28sL` at <https://propeptiq-2mbfe3ck3-sergiosteam.vercel.app> serves that exact SHA on propeptiq.com. Fresh desktop browser checks confirmed all 30 correct individual paths loaded, each with nonzero natural width, and zero measured document overflow; a BPC + TB arrow-key check preserved selected/focused gallery tabs. Locally, nine browser checks include all six products/five scenes at 375/768/1440px; 13 focused components and a durable 238-file / 3,592-test full-unit run passed. Lint, typecheck, workspace boundary, production build and artifact checks passed; both independent reviews approved. The measured new assets are 1,254 × 1,254 pixels and total 1,482,200 bytes. This brings live individual alternate coverage to 60 views across 12 products, leaving 220 views for 44 products shared. Existing fronts, earlier alternates and shared masters are preserved. This is not a fresh live three-viewport matrix or completion of Task 4. [PR #38 release receipt](https://github.com/Shigakuresama/Propeptiq/pull/38) and [batch-two artwork provenance](../../reference/storefront-individual-alternate-imagery-batch-two.md).

**Delivered checkpoint — PR #35:** Task 4E's 30 individual alternate images and Task 20D's checkout/account/order wording are merged as `e4a87e827122466c41c0fba02221d79bf4e283a7`. At that checkpoint, READY production `dpl_2mogPGYBxxSQLJKR7PoGzqrMcHHQ` served the exact commit on propeptiq.com. All 30 alternate paths loaded in the live desktop browser with no measured document overflow; all six products and five scenes were also tested locally at 375/768/1440px. The final candidate passed 3,579 unit tests, 11 gallery browser tests, 38 focused components, lint/typecheck, build and artifact checks; both independent reviews approved after two test fixes. The deployed private checkout/account/order states remain local-test evidence because live inspection reached sign-in. Other 250 alternates, remaining prices/content and wider acceptance are open. [Exact PR #35 release evidence](https://github.com/Shigakuresama/Propeptiq/pull/35).

**Delivered checkpoint — Task 20E / PR #36:** Customer-facing account-access copy is merged to `main` as `07c9a88422d298252cc33dd1a39367e999cea41a`; at that checkpoint READY production `dpl_Cwp2Gwfx15j9LuG4dHZVSjDBk5Bm` served that exact SHA. Fresh public inspection confirmed the approved sign-in, sign-up and password-recovery wording, zero measured document overflow, and preserved `returnTo` navigation. Recovery retained its privacy/enumeration-safe email instruction; no recovery request, credential, OTP or authenticated flow was submitted. Local evidence passed 3,590 unit tests, 26 focused Task 20E tests and the 19-test browser lane; the review repair passed 18 focused tests and two account-access browser tests. Task and final reviews approved. This was not a fresh three-viewport live matrix, provider verification or checkout activation, and wider Task 20 and Task 4 remain Partial.

**Historical September 6 pre-merge snapshot for PR #35:** At this checkpoint, Task 4E added 30 original alternate images for BPC-157, Tirzepatide, Retatrutide, NAD+, Semax and Selank, with five distinct scenes per product. All 56 existing fronts were preserved; the other 250 alternate views remained shared. Task 20D replaced internal checkout/account/order jargon with customer-facing wording without changing payment, account or order behavior. Combined source candidate `5da6ee301e1772a0c13ab00bc0ede4de2c78b248` passed 237 files / 3,579 unit tests, 11 focused gallery browser tests (all six products at 375/768/1440px), lint, typecheck, workspace boundary and production build. The build logged `STOREFRONT_PROMOTION_UNAVAILABLE` in the local environment; it was not proof of live campaign failure or success. Artifact scan: 1,260 files / 70,939,542 bytes / zero forbidden matches; scanner self-tests 11/11. Task 20D additionally passed seven checkout browser tests and its scoped review fixes. At that point, Task 4E and final branch review, PR/main, deployment and live after-checks were still pending; the resulting PR #35 release is recorded above. No full integration, whole-browser, Webpack or field-performance pass was claimed for this static-image and copy batch. See [alternate artwork provenance](../../reference/storefront-individual-alternate-imagery.md).
...
- [ ] **Product pages — information still incomplete.** PR #34 expands the live neutral bibliography to 27 compounds / 47 studies / 2 separately nested correction notices / 0 claims; 29 products remain unmapped. KPV, LL37 and glutathione's exact links, contexts, keyboard disclosures and individual fronts were inspected on READY production `dpl_AkYDEj4zwbK4WgxwrGvueiKzoeLM`, main `097d0cc3345a13c5f5caf53ec76f804557d2ad20`. Complete justified coverage and product-specific technical/storage information. Do not fill the remaining products with unrelated papers or generic protocols.
...
- [x] **Shared footer layout — delivered.** PR #25 provides the transparent brand column, central Shop/Support/Legal links, native disclosures, four authorized social placeholders, and one newsletter form in the footer rather than the homepage. Its READY production deployment and live phone/tablet/desktop checks confirm the responsive layout, repeated FAQ navigation and clearance from visible purchase/search controls. This is not newsletter activation or exact matching to the unavailable reference attachment.
- [x] **Narrow product-content repair — delivered.** PR #26 contains long product/configuration text and the exact quantity row without clipping or smaller controls. True local 195/240/320px tests pass, and live product-body geometry is verified. The separate bounded compact-header repair is delivered by PR #27 below; this checkmark does not close broader Task 18.
- [x] **Bounded compact-header repair — delivered.** PR #27 moves the existing compact home/wordmark/Cart rules to the existing 22rem breakpoint. Live classic-scrollbar proof at requested 320px measured client/scroll width 305px, menu right 288.667px and four 44x44px actions; at requested 375px the 360px document retained the full wordmark. This checkmark covers Task 18B only.
- [ ] **Remaining responsive and performance acceptance — open.** PR #29 delivers the reviewed shared motion, lifecycle and cart-layout corrections. Its retained production-build measurements passed 18 cold samples with CLS 0, 28 JavaScript geometry cases, 14 no-JavaScript cases and four reduced-motion cases, under the documented local conditions. Task 18 remains Partial: these measurements do not prove universal full-site behavior, field performance, 60fps or the separate logo scripting-cost requirement.
- [ ] **Customer-facing language — deployed slices verified, wider Task 20 unfinished.** PR #30 and PR #34 delivered the public homepage/catalog/footer and cart-language slices described above. PR #35 deployed Task 20D's checkout/account/order wording, but those private states were not live-verified because inspection stopped at sign-in. PR #36 now live-verifies the bounded public sign-in, sign-up and recovery wording, overflow and return navigation without submitting a form or authenticating. This is not whole-site copy completion, provider verification or payment activation.
- [ ] **Individual imagery — all 56 fronts and 60 alternates for 12 products live; remaining alternates unfinished.** PR #32 delivered all 56 distinct product fronts; its live catalog census found zero shared fronts or slug/source mismatches. PR #35 added 30 alternate scenes for BPC-157, Tirzepatide, Retatrutide, NAD+, Semax and Selank. PR #38 adds 30 more for HGH, GHK-CU, Tesmorelin, Tesmorelin + IPA, TB500 and BPC + TB, with exact production evidence above. The other 220 alternate views for 44 products remain shared and open. Local checks cover 320/375/768/1440px as applicable; no fresh live three-viewport matrix is claimed. See [front artwork provenance](../../reference/storefront-individual-imagery.md), [first-batch alternate provenance](../../reference/storefront-individual-alternate-imagery.md) and [second-batch alternate provenance](../../reference/storefront-individual-alternate-imagery-batch-two.md). No existing assets were deleted and no physical-packaging approval is asserted.
- [ ] **Footer content and newsletter activation — unfinished.** Supply the missing approved policy/support destinations and privacy content, confirm the existing Resend setup, and enable signup only when it can genuinely subscribe with consent and a working provider. The single footer form is disabled and consent unchecked; no successful subscription is claimed. Social `/` placeholders remain authorized.
...
- [ ] **Final acceptance — not done.** PR #27 completed a bounded 158/158 browser release gate and live bibliography/header verification, but Task 19 remains Partial because the wider storefront and business/provider gates below are unfinished. The earlier visible-content and legacy-cart releases remain verified historical checkpoints. Continue the remaining tasks and record their exact releases instead of calling the whole plan complete.
...
The footer layout was subsequently delivered in PR #25 below; additional bibliography work follows separately. Missing prices, product facts, policy/privacy content, newsletter activation and recurring-commerce decisions remain unchecked.

### Shared footer layout — PR #25, deployed and verified

PR #25 merged as `ec76da306c8979952c595059d7d33122573dc2bd`; READY production deployment `dpl_B9v6yUAM2HZewJgcic3zCSBfL6cv` at <https://propeptiq-l87hdzm2x-sergiosteam.vercel.app> serves <https://propeptiq.com/> and its www alias. The merged tree exactly equals reviewed source `3f04cb62d3f0fa360f2a503ab2d7d305bdeafa3e`.

- The shared footer owns one disabled newsletter form, preserves branded privacy validation and existing legal/research content, and renders one native initially-open disclosure per Shop/Support/Legal group. Existing brand copy, genuine transparent logo, approved `/` social placeholders and current-year attribution are retained. No policy, payment/trust badge, provider configuration or subscription success was invented.
- Root lint, route type generation, typecheck, full unit 232 files / 3,511 tests, Turbopack build and artifact scan passed on `f15ea0e`; the final `3f04cb6` changes only two E2E files, with unchanged application source. Scan: 1,260 files / 70,899,055 bytes / zero forbidden matches. Workspace boundary and scanner self-tests 11/11 passed on unchanged configuration. Focused component 169 and footer/FAQ browser 14 passed; the test repair's focused footer/mobile/FAQ run passed 30/30. Existing jsdom navigation and development/unconfigured-promotion diagnostics remain disclosed.
- The first full browser attempt stopped on an old footer Tab-order expectation; it is not a pass. The test-only repair preserves actual keyboard traversal and clearance checks across all 15 new social/summary/link stops. The final full run at frozen `3f04cb6` passed 144/144, zero skipped/unexpected/flaky, exit 0; merged duration 668.737s, `blob-report/run-20HQPK/merged-results.json`. No new database/provider integration or alternative-bundler run is claimed.
- Independent source review and scoped re-review approved; CodeRabbit covered the final branch with no actionable comments and qlty passed. Hosted Codex review was quota-unavailable, not an approval. The branch preview failed before compilation with resource provisioning failure; no protection/provider/environment change was made. Production READY is verified independently above.
- Fresh live homepage/catalog/Tirzepatide reads at 375/768/1440px confirm one footer-only newsletter, disabled fields, unchecked consent, three initially-open groups, one/two/four outer columns, and zero measured document overflow. Native Shop Enter/Space toggles and repeated keyboard FAQ navigation passed; the settled FAQ heading was 217.39px below a 141.33px header bottom. The live browser's document client width excludes its scrollbar; requested width and document overflow were recorded separately.
- Settled product-footer clearance at 375x812: notices end at 537.23px, visible purchase starts at 610.07px, purchase ends at 728px and search starts at 736px. At 390x520: notices end at 245.25px, purchase starts at 318.07px, ends at 436px and search starts at 444px. Desktop/tablet purchase markup is hidden and was not counted as a visible obstruction. Intermediate scrolling/hydration frames were not treated as settled acceptance. Inspected production warning/error logs were empty, no address/payment write occurred, and the viewport override was reset.

The pre-existing 195px product-body overflow was subsequently repaired by PR #26 below; this footer release itself does not claim universal narrow-page containment. Exact footer-reference matching, missing policies, real social URLs and newsletter activation remain unfinished.

### Narrow product-content repair — PR #26, deployed with a separate header finding

PR #26 merged as `d05f9dbd668aa2a4f535eba1d2183584ff88a8fd`; READY deployment `dpl_GGb6E9P5PFnKbyiYEes1sStgwJvD` at <https://propeptiq-2tx1c5jhm-sergiosteam.vercel.app> serves <https://propeptiq.com/> and its www alias. The merged tree exactly equals tested source `2db39b989be0f2cd170d0469ac177c6bc5065440`.

- The two source-file repair adds minimum-width/emergency-wrap boundaries to product detail grid items and allows the quantity input to shrink inside its existing 200px row. Both buttons remain 44x44px, and the normal input remains 96px. No global clipping, content hiding, changed price/quantity behavior, or gallery/carousel rewrite.
- RED reproduced 32px document overflow at true 195px and two missing class contracts. Focused 63 unit tests and 12 unique browser cases passed (the reported 5/7/4/1 invocations overlap). Full unit: 232 files / 3,511 passed, 34.47s. Final root full browser: 149/149, zero skipped/unexpected/flaky, exit 0, 694.195s; `blob-report/run-9ckVDK/merged-results.json`. The final footer test no longer exempts the narrow PDP.
- Root lint, route type generation, typecheck, fresh Turbopack build, artifact scan and workspace boundary passed. Scan: 1,260 files / 70,899,374 bytes / zero forbidden matches. Existing jsdom navigation, development LCP/NO_COLOR and unconfigured-build promotion diagnostics remain disclosed. No new database/provider integration or alternative-bundler run is claimed.
- Independent whole-branch review approved with no findings; qlty passed. Both hosted reviewers were quota-unavailable, not approvals. Branch preview failed before compilation with resource provisioning failure; no provider/environment/protection setting changed.
- Fresh live Tirzepatide: at requested 240px / client 225px the header/gallery/product-content boxes end at 208.67px, quantity buttons are 44px and the input is 88.67px. The product remains contained at 320px, 375px, 768px, and 1440px; normal input width is 96px. Quantity 2 displays standard 59.99 / effective 41.99, 30% discount, 36.00 savings, and 83.98 subtotal; selection was restored to 1 without adding to cart. The live browser cannot reproduce 195px, so that exact width is proved only by the local browser suite. Inspected warning/error logs were empty and viewport override reset.
- **New live finding, not a pass:** at requested320px/client305px, document overflow is15px because the unchanged header's `Open navigation` button ends at319.96px. Fresh navigation reproduces; bounded related-carousel children are not the cause. Product-body repair is delivered, but Task18B must fix this separate classic-scrollbar/header case before the overall responsive task is complete.

### PR #27 bibliography follow-up — released and live verified

Task 8B source commit `639bb6fc8ea991f7cc2691eec7e4801c6d86c9d8` adds exact ARA-290, SS-31 and Thymosin Alpha-1 joins: six study PMIDs and two separately linked correction notices. PR #27 now serves 20 compounds / 33 studies / 2 notices / zero claims in production; the previous 17 compound and 27 study records and their review dates are unchanged. The 36 remaining products are not padded with inferred citations.

- Fresh NCBI EFetch read-back at September 5, 08:45:46 PDT returned all eight exact records, matching indexed metadata and reciprocal correction relationships. No indexed retraction type/relation was present in that response. This is not blanket clinical/product relevance or DOI-redirect verification.
- Implementer evidence: 83 focused unit/component/route tests, 19 content-browser cases, full unit 232 files / 3,528 tests, lint and typecheck passed. The 4 new browser cases overlap the 19-case run. RED had 19 expected failures; the first missing-section browser RED run was interrupted after its first timeout and is not a complete RED-suite pass. A real contrast failure and a test tuple typing failure were corrected before the passing runs.
- Independent source review found one exact-source regression gap, fixed in test-only commit `a33d22de4dc46f5231aef4665190fa34fac985d1`. Full immutable suffix checks now protect every new compound/study field; focused 83 tests, lint and typecheck passed, and scoped re-review approved with no remaining Important finding. The later combined PR #27 release gate passed as recorded below. No price, cart, promotion, checkout or provider behavior changes are included.

### PR #27 compact-header follow-up — released and live verified

Task 18B source commit `f872b0c1dfb1c7a4fd3774b71acf50431501671f` relocates only the existing compact home/wordmark/Cart rules to the existing 22rem breakpoint. RED at a true 305px local viewport reproduced 15px header overflow and menu right 319.97px; GREEN had zero overflow, menu right 289px and all four controls 44x44px. Explicit 320px compact and 375px full-wordmark checks passed. The five new tests, two existing header tests and five unchanged narrow-product tests provided 12 unique passing browser cases; full unit passed 232 files / 3,528 tests. Initial test-only destination/typing errors and existing runner/jsdom diagnostics remain documented, not represented as pristine output.

PR #27 merged September 5 at 17:25:21Z as `975a96f2ae047bb6b5e94785a5d5da82205833d1`; its merged tree exactly equals tested tree `3d5629ec2186323daf2b1850ab0e779fa33fef75`. READY deployment `dpl_59UcYsjoafr56TpdWC11jbXD91Et` at <https://propeptiq-43xw3wg8h-sergiosteam.vercel.app> serves the `propeptiq.com` and `www` aliases. The final full browser gate passed 158/158 with zero unexpected, skipped or flaky tests; lint, route type generation, typecheck, fresh Turbopack build, workspace-boundary and artifact checks also passed. The production artifact scan covered 1,260 files / 70,924,780 bytes / 0 forbidden matches.

Fresh production checks found equal document client/scroll widths at requested 320/375/768/1440px: 305/360/753/1425px. At 320px the menu ended at 288.667px and home, Cart, sign-in and menu actions were each 44x44px; at 375px the full wordmark remained. ARA-290, SS-31 and Thymosin Alpha-1 each rendered exactly two study references at 375/768/1440px; correction notices remained nested only under their exact parents and did not inflate counts. Native click/Space/Enter disclosure, keyboard focus, the specific `/catalog/ara-290` redirect to `/catalog/items/ara-290`, empty warning/error logs and final viewport reset were verified. Checkout remains disabled, the newsletter remains disabled and unchecked, the cart remained empty, and no address, payment, provider or production-data mutation occurred. This release completes only Task 18B's bounded compact-header repair; broader Task 18 and Task 19 remain Partial/open.
...
**Task 8C delivered in PR #29:** `a9ad6613bedb31f1512eb4a30c71392e8566c98d` appends Selank and Semax plus four exact study records; PR #29 merged as `632ec89cd06b5e7303ac852fe4fee9cf19064a0c`. Published coverage is 22 compounds / 37 studies / 2 notices / 0 claims; the previous 20/33 records remain unchanged and the separate `semax-selank` blend remains unmapped. RED reproduced eight missing-record/join failures; GREEN passed 87 focused checks, 22 product-content browser tests and 233 files / 3,540 full unit tests. Static checks passed and independent scoped review approved the seven-file change. PR #29's production release evidence is recorded above; these counts are not all-catalog completion.

**Task 8D delivered in PR #33:** Main `01f801eed021e28129c4f47b7a4ad3304659e8a2`, READY production `dpl_HE2pyh5ZEM3RpFzSM6E4DwUSLR1K`. DSIP and Epithalon add four independently checked primary records, including explicitly distinguished animal and cell-line evidence. See [dated source verification](../../reference/2026-09-06-dsip-epithalon-bibliography.md) and [release receipt](https://github.com/Shigakuresama/Propeptiq/pull/33). Focused 94/94, browser 25/25 and static/build/scanner passed; the full-unit command exited 0 but its captured footer counts were unavailable and are not fabricated. Independent review approved with no blocking findings. Fresh live exact citations/contexts, Enter/Space focus retention, individual fronts, desktop containment and homepage/search checks passed. New live mobile/no-JavaScript proof is not claimed; local three-width/no-JavaScript evidence is retained. Coverage is 24/41/2/0, not all-catalog completion.

**Task 8E reviewed local candidate `fbbf7b8`:** KPV, LL37 and glutathione add six verified primary records, with a necessary preclinical aggregate correction for KPV's mouse/cell experiments. Local coverage is 27 compounds / 47 studies / 2 notices / 0 claims, with the previous 24/41 parsed records unchanged. Focused 104/104, corrected browser 29/29 and full unit 234 files / 3,566 tests passed; static checks passed. Review found a weakened guidance-language assertion; the test-only repair restored its unchanged regex with one exact verified population-field exception and hostile-field rejection coverage. The covering 65/65 tests passed and scoped review accepted the repair. See [dated source verification](../../reference/2026-09-06-kpv-ll37-glutathione-bibliography.md). Combined release and live verification remain pending. No product-specific technical/storage facts were recovered by the repository audit; those requirements remain open rather than receiving generic filler.

**Browser-evidence correction found during Task 8E:** The current full product-content run initially passed 28/29 cases, failing Epithalon's unchanged no-JavaScript test because it required inner content to be visible before opening the native disclosure. The earlier Task 8D aggregate pass report does not prove this case against that reproducible failure. The test correction opens by keyboard before checking visibility and retains the closed/open/close, exact-source, focus and containment assertions. An intermediate strengthened KPV case also failed because its role query excluded closed-disclosure links; it now counts source anchors structurally while closed and requires visibility after opening. Final affected 5/5 (18.4s) and whole-file 29/29 (1.1m) supersede those earlier claims. All three new products run at each of 375/768/1440px; no product-runtime change was needed for the disclosure test ordering.
...
**September 5 PR #27 release:** The canonical product route loads the bibliography on the server and passes only the entry whose `productSlug` matches the resolved canonical product. `CompoundResearchSection` adds `#research-references` with native disclosure, exact study title/author/year/journal, neutral design/context, available sample/population/duration metadata, PMID/DOI, and verified PubMed links. Missing fields are omitted. Unmapped products omit the section instead of receiving inferred compound matches. Existing exact-name PubMed discovery links remain separately allowlisted by `public-literature.ts`; they are explicitly discovery, not a curated study or product claim. Production checks confirmed two references apiece for ARA-290, SS-31 and Thymosin Alpha-1 at requested 375/768/1440px, exact correction nesting, native disclosure and keyboard focus, and the specific ARA-290 legacy redirect. Product-specific technical/storage facts and the complete approved notice/content set are still unfinished.
...
- [x] Verify four columns on desktop, two on tablet, and stacked keyboard-accessible disclosures on mobile without hiding links when JavaScript is delayed. Delivered by PR #25; native/no-JavaScript browser tests and live responsive/keyboard evidence are recorded above.
...
- [x] **18F — bounded local production-build measurements.** The final isolated run on `db991c54a46b565bba40b9d9ba3ec510c20a1f73` passed on September 6 UTC / September 5 Pacific: six Playwright cases, 18 cold samples with CLS 0 and no integrity failures, 28 JavaScript geometry cases, 14 completed no-JavaScript cases, four reduced-motion cases, and two 30-second frame observations. Build `6wZM_OU0FNiwyy8GP1eg0`, source fingerprint and harness hashes remained stable. Production build and scan passed (1,260 files / 70,938,003 bytes / zero forbidden matches). Evidence is retained under `.superpowers/artifacts/storefront-performance/2026-09-06T01-23-10-247Z-cc83d16d-5e3d-4bf5-8f18-c98b6ca676ab/`. Earlier failed runs remain failures, including the fourth run's five interrupted no-JavaScript scroll checks; its diagnosed native-scroll correction passed the final run. This is 4x CPU, unthrottled localhost with tracing, not field performance, 60fps proof, or a scripting-cost measurement. Full Task 18 remains partial pending its separate requirements and live release proof.
- [ ] **18H — diagnosed cart layout corrections.** Local commit `081a5f6b3bead81f3e106d5d04cb67612eded254` anchors the visually hidden cart announcement and contains the empty-cart catalog action at 195px. The separate regressions reproduced the footer footprint and 43px CTA overflow before correction. Final checks passed 51 component tests, two phone-browser tests, lint, typecheck and workspace boundary; accessibility semantics, cart behavior and the original 1px containment threshold are preserved. Independent exact-diff review approved the five-file change with no Critical or Important findings. Merge and live proof remain pending.

**Local evidence-retention incident:** a focused Playwright command inherited the default `test-results` output directory, which Playwright clears at startup. That removed the earlier nested performance and footer-diagnostic raw archives. No raw backup exists; human/tool-observed summaries and historical hashes remain, but are not a substitute for reproducible raw evidence. Source files, product assets and customer data were not removed. Surviving later regression artifacts were copied outside that output tree. Future measurement output must be isolated from ordinary browser-test cleanup; no earlier failed run is relabeled as passing or reconstructed.
...
| 8 | PR #27 merge `975a96f2ae047bb6b5e94785a5d5da82205833d1`; tested tree `3d5629ec2186323daf2b1850ab0e779fa33fef75` | 232 files / 3,528 unit tests; final browser 158/158; static/build/artifact gates passed | Exact-source gap fixed; scoped re-review approved; CodeRabbit and qlty passed | READY `dpl_59UcYsjoafr56TpdWC11jbXD91Et` at <https://propeptiq-43xw3wg8h-sergiosteam.vercel.app> and production aliases | NCBI read-back for eight added records; live exact two-reference/correction-link projection at 375/768/1440px | Partial — released 20 compounds / 33 studies / 2 notices / 0 claims; 36 products unmapped and broader research/content requirements open |
...
| 18 | PR #27 merge `975a96f2ae047bb6b5e94785a5d5da82205833d1`; tested tree `3d5629ec2186323daf2b1850ab0e779fa33fef75` | Final browser 158/158 plus static/build gates | CodeRabbit and qlty passed | READY `dpl_59UcYsjoafr56TpdWC11jbXD91Et` at <https://propeptiq-43xw3wg8h-sergiosteam.vercel.app> and production aliases | Task 18B: contained 305/360/753/1425px documents, correct compact/full wordmark states and 44px actions | Partial — bounded compact-header repair delivered; full motion, width matrix, CLS and 4x CPU work remains open |
...
### PR #29 and PR #30 delivered; Task 20C continuation
...
Task 20B delivered those homepage/catalog/footer descriptions, generated product introductions, neutral FAQ explanations and legacy cart-page text in [PR #30](https://github.com/Shigakuresama/Propeptiq/pull/30), main `af3c8542177a95c92e20b450de0d581c6c181cb4`, READY production `dpl_7g9K495H7ixpyzrGbthVYoBXnPQL`. Its exact verification receipt is recorded above. Price/availability notices, research restrictions, source identities, bibliography and commerce behavior are preserved.

Task 20C addresses the remaining header count, cart heading, retry, item subtotal, saved-item and legacy-cart instructions. The audit distinguishes customer-visible text from private `preview` identifiers and preserves honest unavailable states. This continuation is not delivered until its own reviewed release and live checks pass; the separate gated checkout-form wording remains open for a state-aware audit.

**Task 20C local candidate `44385d5`:** the three cart runtime files now use the specified item labels and concise recovery instructions without changing payment, identity, price, storage, navigation, or acknowledgement logic. Focused six-suite checks passed 110/110; final combined unit checks passed 234 files / 3,566 tests (37.87s); all seven affected browser files passed 98/98 (6.2m). Lint, typecheck, workspace boundary and diff checks passed. Existing jsdom navigation notices, development hydration diagnostics, color-variable warnings and Next image LCP advisories are disclosed; warning-free output and full-site production acceptance are not claimed. The account status component is independent of CartView, so its unchanged test was regression-only rather than receiving a fabricated edit. Task/final review, production build, merge, deployment and live read-back follow these local gates.
...
Fresh unit verification passed 233 files / 3,541 tests; integration passed 551 tests with three explicitly guarded skips and unchanged application/integration input hashes. Lint, typecheck, workspace boundary, artifact-scanner 11/11 and migration consistency passed. Browser evidence is combined, not a falsely reported clean full invocation: 77/78 passed before the full command stopped, 95/96 passed in the remaining-case continuation, and all 12 focused replacement/regression cases passed after two test-only readiness/serialization corrections. This covers every one of the 174 existing cases plus the new delayed-fade readiness case. Full and scoped reviews approved the source; CodeRabbit and qlty passed on the reviewed checkpoints. The final production-build run above passed. Guarded external PostgreSQL, provider-positive and live payment lanes were not run.

At this recorded checkpoint, merge and production read-back follow these local gates; consult PR #29 for the resulting merge/deployment/live evidence. Preview deployments fail before building with `Resource provisioning failed`; the same error predates this PR, and a successful main deployment must be observed independently. Do not equate this bounded release with the remaining individual photos, 63 unresolved prices, complete product-specific content, newsletter/calculator activation, or recurring-commerce work. Task 20B is deferred until after this release, not removed from scope.
