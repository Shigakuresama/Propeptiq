...
- [ ] **Product pages — information still incomplete.** PR #29 expands the live neutral bibliography to 22 compounds / 37 studies / 2 separately nested correction notices / 0 claims; 34 products remain unmapped. Complete justified coverage and product-specific technical/storage information. Do not fill the remaining products with unrelated papers or generic protocols.
...
**Task 8D in implementation:** DSIP and Epithalon have four independently checked primary records, including explicitly distinguished animal and cell-line evidence. See [dated source verification](../../reference/2026-09-06-dsip-epithalon-bibliography.md). This candidate requires tests, review, merge, production deployment and live page checks before it changes the delivered counts above. No product-specific technical/storage facts were recovered by the current repository audit; those requirements remain open rather than receiving generic filler.
