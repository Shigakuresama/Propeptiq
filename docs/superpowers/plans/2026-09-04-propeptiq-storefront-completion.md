...
**Task 8E local candidate `974af25`:** KPV, LL37 and glutathione add six verified primary records, with a necessary preclinical aggregate correction for KPV's mouse/cell experiments. Local coverage is 27 compounds / 47 studies / 2 notices / 0 claims, with the previous 24/41 parsed records unchanged. Focused 104/104, corrected browser 29/29 and full unit 234 files / 3,566 tests passed; static checks passed. See [dated source verification](../../reference/2026-09-06-kpv-ll37-glutathione-bibliography.md). Review, release and live verification remain pending. No product-specific technical/storage facts were recovered by the repository audit; those requirements remain open rather than receiving generic filler.
